...
public class ColorMapCreator {
    ...
    public void createDot(String destpath) throws IOException {
        ...
        if (this.matched) {
            this.fileWriter =
                    new BufferedWriter(new FileWriter(destpath + "_matched.dot"));
        } else {
    ...
    private void writeNodes(int node, String destpath) throws IOException {
        ...
        if (this.created) {
            fileWriter.write(String.format("\t%s %s%s%s%s", node,

                    DOT_FILLCOLOR_OPEN, colorMap.get(node), DOT_FILLCOLOR_CLOSE,
            ...
            BufferedReader br =
                    new BufferedReader(new FileReader((destpath + "_cm")));
    ...
    public void matchGraph(String input, String destpath) throws IOException {
        ...
        Map<String, Integer> cutEdges = new HashMap<>();
    ...
    public void countCutEdges(String kway_input) throws IOException {
